...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.realestatewithshirin.com/articles/north-idaho-school-districts-open-enrollment-charters',
  },
  url: 'https://www.realestatewithshirin.com/articles/north-idaho-school-districts-open-enrollment-charters',
  keywords: [
    'North Idaho schools',
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="font-dm-sans text-xs text-[#9A9590]">Licensed REALTOR® · eXp Realty · May 21, 2026</p>
            </div>
          </div>
        </div>
      </section>
