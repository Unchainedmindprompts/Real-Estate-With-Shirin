        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="font-dm-sans text-xs text-[#9A9590]">Licensed REALTOR® · eXp Realty · May 19, 2026</p>
            </div>
          </div>
        </div>
      </section>
