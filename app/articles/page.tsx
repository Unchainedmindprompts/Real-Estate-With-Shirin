      ...
      <section className="section-padding" style={{ backgroundColor: '#F5EFE6' }}>
        <div className="max-w-4xl mx-auto px-6 lg:px-8 space-y-6">
          ...
          >
            ...
            <p style={{ fontFamily: "'DM Sans', system-ui, sans-serif", fontSize: '15px', color: '#9A9590', lineHeight: 1.7, marginBottom: '24px' }}>
              Four mountain ranges, four major lakes, three rivers, and a major airport &mdash; all within an hour of downtown Coeur d&apos;Alene. The geography that keeps pulling relocation buyers here, explained.
            </p>
            <div className="flex items-center justify-between">
