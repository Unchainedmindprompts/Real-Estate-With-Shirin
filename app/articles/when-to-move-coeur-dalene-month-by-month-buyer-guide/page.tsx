...
const articleSchema = {
  ...
  mentions: [
    ...
    { '@type': 'Event', name: 'Art on the Green', url: 'http://artonthegreencda.com/' },
    { '@type': 'Event', name: "Holiday Light Show: A Coeur d'Alene Christmas", url: 'https://coeurdalene.org/events/holiday-light-show-a-coeur-dalene-christmas/' },
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="lg:grid lg:grid-cols-3 lg:gap-12">
            ...
            <article className="lg:col-span-2 font-dm-sans text-[#5C5650] text-[17px] leading-[1.75]">
              ...
              <p className="mb-10">Mid-year school enrollment is easier here than most newcomers expect. Class sizes in the Coeur d&rsquo;Alene, Post Falls, Hayden, and Lakeland districts are smaller than what most relocating families are leaving behind, and transfer students show up regularly.</p>
              ...
              <p className="mb-6">
                If you&rsquo;re trying to figure out how to time your move &mdash; the school calendar, the real estate window, the season you want to arrive in &mdash; I&rsquo;d be glad to walk through it with you. I&rsquo;ll give you the honest version.{' '}<a href="/contact" className={linkClass}>Schedule a call with Shirin &rarr;</a>
              </p>
