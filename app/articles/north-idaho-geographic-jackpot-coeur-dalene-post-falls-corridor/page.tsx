          ...
          <div className="lg:grid lg:grid-cols-3 lg:gap-12">
            ...
            <article className="lg:col-span-2 font-dm-sans text-[#5C5650] text-[17px] leading-[1.75]">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-3">
                ...
                <li><strong className="text-[#1C1A17]">In-town Coeur d&rsquo;Alene.</strong>{' '}Walkable, restaurant-dense, lakefront-adjacent. Premium per-square-foot pricing, smaller lots, character homes mixed with new builds. Deeper read:{' '}<a href="/areas/coeur-dalene-idaho" className={linkClass}>the Coeur d&rsquo;Alene living guide</a>.</li>
                <li><strong className="text-[#1C1A17]">Post Falls.</strong>{' '}This is where buyers go when they want Spokane access, newer construction, more square footage per dollar, and a genuine community feel. It&rsquo;s the corridor&rsquo;s value play. Deeper read:{' '}<a href="/areas/post-falls-idaho" className={linkClass}>the Post Falls living guide</a>.</li>
                <li><strong className="text-[#1C1A17]">Hayden.</strong>{' '}Established residential neighborhoods, strong schools, lake proximity, and a quieter pace. A favorite of buyers who want to age in place. Deeper read:{' '}<a href="/areas/hayden-idaho" className={linkClass}>the Hayden living guide</a>.</li>
